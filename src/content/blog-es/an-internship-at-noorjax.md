---
title: "Una Pasantía en Noorjax"
slug: "an-internship-at-noorjax"
date: 2022-04-07
categories: ["About Noorjax"]
tags: []
excerpt: "Joaquín Guzmán terminó recientemente una pasantía en Noorjax por un total de 2 meses, donde pudo apoyar el desarrollo de modelos de simulación y la validación de estos modelos usando técnicas de ciencia de datos"
---
...
## Modelo de Simulación de Logística de Recinto

En 2021, Noorjax desarrolló un modelo de simulación usando AnyLogic para capturar la logística de un recinto para una reconocida empresa automotriz. En este proyecto, Joaquín mejoró este modelo agregando nuevos escenarios, nuevas opciones de configuración e incluyó características 3D para los requisitos del modelo.
...
Joaquín también agregó visualizaciones 3D especiales, que llevaron a descubrimientos interesantes sobre cómo AnyLogic maneja estas cosas. Esto fue transformado en una publicación de blog que se puede encontrar [AQUÍ](/es/blog/blog-camera-on-agent/).

## Percepciones Verídicas – Modelo de Simulación Basado en Agentes en espacio discreto
...
## Apoyo en el desarrollo de cursos relacionados con simulación

Noorjax tiene muchos cursos que se pueden encontrar en [https://noorjax.teachable.com](https://noorjax.teachable.com) y hay nuevos cursos en desarrollo. Joaquín ayudó con las siguientes cosas:

- Desarrollo de ejercicios para el curso basado en agentes que algún día será lanzado

- Desarrollo de ejercicios para la biblioteca de peatones que actualmente es gratuita

- Revisión del contenido para el curso basado en agentes que algún día será lanzado

## Modelo de Simulación de Cadena de Suministro y Producción de Almendras

Noorjax está actualmente desarrollando un modelo de simulación a gran escala para un productor de almendras bastante grande. El modelo tiene varios bloques personalizados que realizan ciertas tareas. Joaquín ayudó a intentar encontrar soluciones para estos bloques, tratando de hacerlos funcionar en todas las situaciones en lugar de la simplificación que estaba presente en el modelo. Esto no se logró al 100%, por lo que el trabajo pronto se transformará en una competencia de AnyLogic que será lanzada próximamente.
...
## Laboratorio Covid – Modelo de Simulación
...
El trabajo asociado al ajuste de distribuciones fue transformado en un video de YouTube disponible [AQUÍ](https://youtu.be/wxLZvfwJq0U). Joaquín ayudó con el contenido y la presentación de este video.

## Modelo de Simulación de Flujo Comercial
...
Joaquín hizo un excelente trabajo durante estos 2 meses y fue un apoyo significativo en muchos dominios diferentes de conocimiento. También declaró que aprendió una cantidad significativa durante el desarrollo de cada proyecto y no esperaba que el tipo de trabajo fuera tan variado.

Si quieres hacer tu pasantía en Noorjax Consulting, déjanos saber. Envíanos tu información a [info@noorjax.com](mailto:info@noorjax.com) y podemos ofrecerte una oportunidad para aprender y experimentar el mundo de las simulaciones.
