---
title: "An Internship at Noorjax"
slug: "an-internship-at-noorjax"
date: 2022-04-07
categories: ["About Noorjax"]
tags: []
excerpt: "Joaquín Guzman recently finished an internship at Noorjax for a total of 2 months, where he was able to support the development of simulation models and the validation of these models using data scien"
---
...
## Compound Logistics Simulation Model

In 2021, Noorjax developed a simulation model using AnyLogic to capture the logistics of a compound for a well-known automotive company. On this project, Joaquin improved on this model adding new scenarios, new configuration options and included 3D features for the model requirements.
...
Joaquin also added special 3D visualizations, that led to interesting discoveries on how AnyLogic handles these things. This was transformed into a blog post that can be found [HERE](/en/blog/blog-camera-on-agent/).

## Veridical Perceptions – Agent Based Simulation Model in discrete space
...
## Support on the development of simulation related courses

Noorjax has many courses that can be found at [https://noorjax.teachable.com](https://noorjax.teachable.com) and there are new courses in development. Joaquin helped with the following things:

- Development of exercises for the one day to be released agent-based course
- Development of exercises for the pedestrian library that is currently free
- Revision of the content for the one day to be released agent-based course

## Almonds Supply Chain and Production Simulation Model
...
## Covid Laboratory – Simulation Model
...
The work associated to distribution fitting was transformed into a [YouTube video](https://youtu.be/wxLZvfwJq0U). Joaquin helped with the content and presentation of this video.

## Commercial Flow Simulation Model
...
Joaquin did a great job during these 2 months and was a significant support in many different domains of knowledge. He also stated that he learned a significant amount during the development of each project and didn't expect that the kind of work would be so variated.

If you want to do your internship at Noorjax Consulting, let us know. Send us your info at [info@noorjax.com](mailto:info@noorjax.com) and we can offer an opportunity for you to learn and experience the simulations world.
